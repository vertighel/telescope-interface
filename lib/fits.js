...
(function() {
	...
	Image.prototype._getFrame = function(buffer, bitpix, bzero, bscale) {
		...
		while (nPixels--) {
		    ...
		    arr[nPixels] = bzero + bscale * swapEndian(tmp[nPixels]);
		}
	    } else {
	...
	Image.prototype.getFrame = function(frame, callback, opts) {
	    var begin, blobFrame, blobs, buffers, bytesPerBuffer, frameInfo, i, nRowsPerBuffer, reader, start, _i, _ref, _this = this;
